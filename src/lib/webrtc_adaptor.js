...
function WebRTCAdaptor(initialValues)
{
	...
	this.checkExtension = function() {
      ...
      console.log('checkExtension');
        ...
        console.log('rtcmulticonnection-extension-loaded');
	...
	this.initPeerConnection = function(streamId) {
		if (thiz.remotePeerConnection[streamId] == null)
		{
			...
			console.log("stream id in init peer connection: " + streamId + " closed stream id: " + closedStreamId);
        ...
        console.log('iceCandidateReceived', event);
